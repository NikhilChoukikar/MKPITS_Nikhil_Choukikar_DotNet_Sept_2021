...
-------------------------------------------------------------------------------
Select firstname,Lastname,english,maths,sci,(english+maths+sci)/3 as 'Average' from student;

Select * from student where sci<90 and maths>80;

Select firstname,lastname,english from student  where english = (Select max(english) from student);

-----------------------------------------------------------------------------------

Select avg(maths) as 'Avg Maths marks' from student;
Select avg(English) as 'Avg English marks' from student;
Select avg(sci) as 'Avg Science marks' from student;